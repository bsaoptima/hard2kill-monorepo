export function WalletBox({
  ...
  return (
    <div
      className="flex items-center gap-3 bg-card border border-border px-4 py-2 min-w-[120px] hover:border-primary/40 transition-colors"
      style={{
        boxShadow: "inset 0 1px 0 rgba(255, 255, 255, 0.04)",
      }}
    >
      <div className="w-[3px] h-7 bg-primary" />
